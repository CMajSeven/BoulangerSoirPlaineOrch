...
It should be noted in interpreting the dynamic markings that FM has limited dynamics in general, and only ranges from \dynmark{\ppp} to \dynmark{\mf}. Editorial dynamics are generally inserted from PE.
...
\mbox{44--51}: The \mbox{Vl.~I} melody and many harmonies of FM are rewritten in RM and PE. The \mbox{Vl.~I} melody seems more appropriate as a solo.
...
\mbox{54, Cor 4}: The orchestration seems overly empty after moving Bon.~1 and Cor~1.2 later. Adding concert G\textsubscript{2} as in reductions
...
\mbox{100, T, B}: Last two \Vier s are aligned with the \Vier\Pu\ \Acht\ of the Soprano and Contralto in FM. Ténors in RM and PE have \Vier\Pu\ \Acht\ \ .
...
\mbox{101, Chœur}: This divisi is taken from PE, which notates it as a double choir. FM and RM simply add another set of staves at 103, and so it is not clear who is singing this second part or how they transition into it.
...
\mbox{107--110, S}: Unclear what the meaning of the slur and the broken tie with a continuous ``Ah!'' lyric in FM means, perhaps a breathing point. Continuous tie with no slur in RM and PE

\mbox{107--110, Chœur}: Slur and ``Ah!'' lyric broken at first eighth of 108 in RM and PE 

\mbox{110, Vl.~II.2}: Originally F♮ in FM corrected to D♮

\mbox{111--112, Hpe.~1}: First notes of these measures written as quarter notes in FM. Unclear if this is meaningful, rewritten as eighth notes to be consistent with similar measures

\mbox{114, Obs}: Second half of measure is unfilled in FM. Filling with G\scalebox{1.5}{\musDoubleSharp}s like measure 34
